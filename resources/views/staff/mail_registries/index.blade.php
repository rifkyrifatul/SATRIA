...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <form method="GET" action="{{ route('staff.mail_registries.index') }}"
        ...
        <div class="relative w-full md:w-36">
            <select name="type" class="w-full appearance-none pl-4 pr-9 py-2.5 text-sm border border-slate-300 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-900/50 text-slate-600 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
        ...
        <div class="relative w-full md:w-40">
            <select name="month" class="w-full appearance-none pl-4 pr-9 py-2.5 text-sm border border-slate-300 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-900/50 text-slate-600 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
        ...
        {{-- Filter Tahun --}}
        <div class="relative w-full md:w-36">
            <select name="year" class="w-full appearance-none pl-4 pr-9 py-2.5 text-sm border border-slate-300 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-900/50 text-slate-600 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
