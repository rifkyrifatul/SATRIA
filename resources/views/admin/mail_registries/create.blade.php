...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border-2 border-slate-300 dark:border-slate-600 shadow-sm p-6">
        <form action="{{ Auth::user()->isSuperAdmin() ? route('super_admin.mail_registries.store') : route('admin.mail_registries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
