                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <form action="{{ route('super_admin.trash.templates.restore', $template->id) }}" method="POST">
                                    @csrf @method('PUT')
                                ...
                                <form action="{{ route('super_admin.trash.templates.force_delete', $template->id) }}" method="POST" onsubmit="confirmDelete(event, 'Yakin hapus permanen? File template akan ikut terhapus.');">
                                    @csrf @method('DELETE')
